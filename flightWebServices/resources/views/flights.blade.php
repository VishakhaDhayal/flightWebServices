...
<div class="content-wrapper">
    ...
    <div class="stunning-header stunning-header-bg-lightviolet">
        <div class="stunning-header-content">
            <h1 class="stunning-header-title">Search Flights Information</h1>
        </div>
    </div>
    <div>
      <input type="text" name="" value="" placeholder="From">
      <input type="text" name="" value="" placeholder="To">
      <input type="text" name="" value="" placeholder="Departure Date">
    </div>
</div>
            ...
            <div class="info">
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="heading text-center">
                        <h3 class="heading-title" >Flighthub!</h3>
            ...
            <div class="contacts">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">flighthub@test.com</a>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">Montreal, Canada</a>
